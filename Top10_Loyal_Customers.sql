/* f)  let's say you want to give discounts as a reward to your loyal customers and those 
who return movies they rented on time. So, who are your 10 best customers in this respect?
*/

SELECT re.customer_id, cus.first_name, cus.last_name, 
				COUNT(rental_id) as On_time_returns
FROM rental re
	JOIN customer cus
